...
export default class Client {
  ...
  // async sendRcvProto(service, module, fn, params) {
  //   // TODO: implement calls from zmq-access.mjs, its a repetitive task to put
  //   // decode/encode in every worker function call
  // }
}
